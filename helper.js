...
function drawSegmentOne(x, y, length, width){

}
function drawSegmentTwo(x, y, length, width){

}
function drawSegmentThree(x, y, length, width){

}
function drawSegmentFour(x, y, length, width){

}
function drawSegmentFive(x, y, length, width){

}
function drawSegmentSix(x, y, length, width){

}
function drawSegmentSeven(x, y, length, width){
  let vertices = [
    x + width/2, y + width/2, 
  ];
